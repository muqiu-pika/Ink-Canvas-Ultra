...
OutputDir=..\..\dist
#define OutputBaseFilename "Ink.Canvas.Ultra.V" + MyAppVersion + ".ARM64.Setup"
...
[Files]
Source: "..\..\Ink Canvas\bin\ARM64\Release\Ink Canvas Ultra.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\Ink Canvas\bin\ARM64\Release\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
